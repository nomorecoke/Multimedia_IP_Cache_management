#ifndef __LG_VIDEO_DISPLAY_HH__
#define __LG_VIDEO_DISPLAY_HH__
...
#include "debug/LGVideoDisplay.hh"
#include "params/LGVideoDisplay.hh"

class LGVideoDisplay : public MemObject
{
    public:
        LGVideoDisplay(const LGVideoDisplayParams *params);
        virtual ~LGVideoDisplay();
        ...
        EventWrapper<LGVideoDisplay, &LGVideoDisplay::tick> tickEvent;
