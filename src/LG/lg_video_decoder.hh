#ifndef __LG_VIDEO_DECODER_HH__
#define __LG_VIDEO_DECODER_HH__
...
#include "debug/LGVideoDecoder.hh"
#include "params/LGVideoDecoder.hh"

class LGVideoDecoder : public MemObject
{
    public:
        LGVideoDecoder(const LGVideoDecoderParams *params);
        virtual ~LGVideoDecoder();
        ...
        EventWrapper<LGVideoDecoder, &LGVideoDecoder::tick> tickEvent;
