#ifndef __LG_VIDEO_CAMERA_HH__
#define __LG_VIDEO_CAMERA_HH__
...
#include "debug/LGVideoCamera.hh"
#include "params/LGVideoCamera.hh"

class LGVideoCamera : public MemObject
{
    public:
        LGVideoCamera(const LGVideoCameraParams *params);
        virtual ~LGVideoCamera();
        ...
        EventWrapper<LGVideoCamera, &LGVideoCamera::tick> tickEvent;
